...
| 4 | Ask-to-remember | Post-swap prompt persisting the swap for the block via updateProgramExercise (wger-only; keeps overrides, re-tags muscles) | complete | - | 1 | [plan](../plans/completed/exercise-replacement-remember.plan.md) · [report](../reports/exercise-replacement-remember-report.md) |
