...
| 4 | Ergonomics + connection doc | `userId` env/arg resolution polish, structured tool errors, optional `workout://{id}` resource, README/skill on connecting an MCP client | complete | - | 2, 3 | [plan](../plans/completed/mcp-ergonomics-and-connection-doc.plan.md) · [report](../reports/mcp-ergonomics-and-connection-doc-report.md) |
