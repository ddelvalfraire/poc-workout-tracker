...
/**
 * Segment loading state for /ops/billing — same contract as the other ops
 * tabs: the REAL header immediately (Billing already active, so the tab nav
 * answers the click before the data does), then ghost panels on this page's
 * exact grid, classes copied from page.tsx verbatim for a zero-shift resolve.
 */
export default function OpsBillingLoading() {
  return (
    <div className="flex min-h-[100dvh] flex-col">
      <OpsHeader active="billing" />

      <main aria-busy="true" className="mx-auto w-full max-w-screen-2xl flex-1 px-5 pb-safe pt-5">
