  ...
  const headline =
    bestPace !== null
      ? {
          ...
          value: formatPace(unit === 'lb' ? secPerMile(bestPace.secPerKm) : bestPace.secPerKm),
  ...
  return (
    <Link href="/stats" className="flex h-full flex-col transition-colors active:bg-muted/60">
      ...
      <span className="mt-auto flex flex-col justify-end">
        ...
        <span className="mt-1.5 block text-[0.7rem] text-muted-foreground">{headline.caption}</span>
      </span>
