...
// Typed to the namespace under test: an unparameterised
// ReturnType<typeof useTranslations> instantiates every namespace in the
// catalog, which exceeds TypeScript's depth limit now that it is app-wide.
const html = (render: (t: ReturnType<typeof useTranslations<'WorkoutDetail'>>) => ReactNode) =>
