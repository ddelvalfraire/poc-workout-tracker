            ...
            {suggestions.map((result) => (
              <li key={resultKey(result)}>
                <button
                  ...
                  className="flex w-full items-center gap-4 py-4 text-left transition-colors outline-none hover:bg-muted/50 focus-visible:ring-3 focus-visible:ring-ring/50"
                >
