...
describe('DividerRow', () => {
  test('renders li > link with the settings link-row recipe and a chevron', () => {
    ...
    // wash — bg-muted/50 over the page background is ~1.1:1, invisible.
    expect(html).toContain(
      'flex items-center justify-between gap-4 py-4 transition-colors outline-none hover:bg-muted/50 focus-visible:ring-3 focus-visible:ring-ring/50',
    )
